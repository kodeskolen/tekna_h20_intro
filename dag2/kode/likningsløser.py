# -*- coding: utf-8 -*-
"""
Created on Mon Sep 14 19:33:34 2020
...
for forsøk in range(1,maks_forsøk+1):
    ...
    if abs(f(gjett)) < feilterskel:
        print("Jippi! Jeg er en flink maksin!")
        print(f"brukte {forsøk} forsøk")
    ...
    print(f"Jeg brukte opp alle {maks_forsøk} uten å finne nullpunktet. Det er et sted mellom {min_tall} og {maks_tall}")
